<template>
  ...
  <div class="grid grid-cols-6">
    ...
    <div
      class="p-2 font-bold text-lg text-center cursor-pointer"
      @click="orderByQuantity((isOrderedQuantity = !isOrderedQuantity))"
    >
      Quantity
    </div>
    <div
      class="p-2 font-bold text-lg text-right cursor-pointer"
  ...
  <div class="grid grid-cols-6 border-b" v-for="(good, index) in goods" :key="index">
    ...
    <div class="p-2 text-right">
      <div class="flex justify-end space-x-3">
        <!-- start edit icon -->
        <div class="cursor-pointer" title="Edit" @click="onEdit(index, good)">
          <svg
        ...
        <!-- start delete icon -->
        <div class="cursor-pointer" title="Delete" @click="onDelete(index)">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
